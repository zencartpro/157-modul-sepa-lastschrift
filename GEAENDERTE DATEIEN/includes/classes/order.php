 ...
 * @version $Id: order.php for SEPA Lastschrift 2024-04-12 13:45:25Z webchills $
 */
/**
 * order class
 *
...
/* END: ADD MY CUSTOM DETAILS */
    ...
    $html_msg['FOOTER_SEPALASTSCHRIFT_REFERENZ_TITLE'] = MODULE_PAYMENT_SEPALASTSCHRIFTEU_TEXT_EMAIL_MANDATSREFERENZ;
    $html_msg['FOOTER_SEPALASTSCHRIFT_REFERENZ_NUMBER']    = MODULE_PAYMENT_SEPALASTSCHRIFTEU_REFERENCE_PREFIX . $zf_insert_id;
        } else {
